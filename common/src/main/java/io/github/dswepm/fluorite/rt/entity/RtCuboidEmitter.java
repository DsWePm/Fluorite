...
final class RtCuboidEmitter {
    ...
    private static final class PartTemplate {
        ...
        static PartTemplate create(ModelPart part) {
            ...
            List<ModelPart.Cube> sourceCubes = access.fluorite$cubes();
            ...
            Map<String, ModelPart> sourceChildren = access.fluorite$children();
        ...
        boolean matches(ModelPart candidate) {
            ...
            List<ModelPart.Cube> currentCubes = access.fluorite$cubes();
            ...
            Map<String, ModelPart> currentChildren = access.fluorite$children();
