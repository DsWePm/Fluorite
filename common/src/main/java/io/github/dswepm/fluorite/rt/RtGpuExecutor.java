...
/**
 * Single-owner asynchronous GPU submission lane on a queue reserved by Fluorite at device creation.
...
public final class RtGpuExecutor {
    ...
    RtGpuExecutor(RtContext ctx) {
        ...
        createCommandPool();
        this.thread = new Thread(this::run, "Fluorite GPU executor");
    ...
    private void execute(List<Job> batch) {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            VulkanDiagnostics.noteQueueSubmission(computeQueue.vkQueue(), "Fluorite compute queue");
