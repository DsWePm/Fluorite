 ...
 * {@link io.github.dswepm.fluorite.rt.RtComposite} reads the per-frame offset, applies it to the primary ray in the
 * path-tracing shader, and reports it to DLSS-RR's evaluate.
 */
public final class FluoriteJitter {
	public static final FluoriteJitter INSTANCE = new FluoriteJitter();

	private int frameIndex;
	private float pixelsX;
	private float pixelsY;

	private FluoriteJitter() {
	}
