 ...
 * {@code MinecraftMixin#fluorite$reflexSleep}).
 *
...
public final class RtReflex {
    ...
    public static boolean enabled() {
        return FluoriteConfig.Rt.Reflex.ENABLED.value() && RtDeviceBringup.reflexEnabled();
    }
    ...
    public void applySleepMode(VkDevice device, long swapchain) {
        ...
        boolean boost = FluoriteConfig.Rt.Reflex.LOW_LATENCY_BOOST.value();
        int minIntervalUs = FluoriteConfig.Rt.Reflex.MINIMUM_INTERVAL_US.value();
        ...
        try {
            ...
            FluoriteMod.LOGGER.info("Reflex: sleep mode applied (boost={}, minIntervalUs={})", boost, minIntervalUs);
        } catch (Throwable t) {
            failed = true;
            FluoriteMod.LOGGER.error("Reflex: applySleepMode failed; Reflex disabled for session", t);
        }
    }
    ...
    public void sleep(VkDevice device, long swapchain) {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            if (r != VK10.VK_SUCCESS) {
                ...
                FluoriteMod.LOGGER.warn("Reflex: vkWaitSemaphores({}) returned {}; pacing skipped this frame",
                        counter, r);
            }
        } catch (Throwable t) {
            failed = true;
            FluoriteMod.LOGGER.error("Reflex: sleep failed; Reflex disabled for session", t);
        }
    }
    ...
    public void marker(VkDevice device, long swapchain, int marker, long id) {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            FluoriteMod.LOGGER.warn("Reflex: vkSetLatencyMarkerNV({}) threw; ignoring", marker, t);
        }
    }
