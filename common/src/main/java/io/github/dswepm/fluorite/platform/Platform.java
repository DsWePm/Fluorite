 ...
 * place: {@code FluoriteConfig.resolveConfigPath()} wraps its call in {@code catch (Throwable)} and falls
 * back to a relative {@code config/fluorite.toml}, which is what lets the JUnit suite construct settings
...
public final class Platform {
	...
	public static PlatformServices get() {
		...
		if (current == null) {
			throw new IllegalStateException("Fluorite platform services were not installed; "
