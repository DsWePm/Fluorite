...
final class RtMaterialLayoutTest {
    ...
    void reflectedWorldPushConstantsIncludeLightBuffersAndDebugView() {
        ...
        // queue) + 3 uint. The ceiling that matters is Vulkan's guaranteed 128, not the 256 this
        // comment used to cite: a driver may offer more, but anything past 128 is not portable.
