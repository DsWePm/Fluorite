...
- 诊断：视频设置 → Fluorite Settings → 诊断 → debug view 1–27（1–7=guide buffer；8–25=体积/水/LUT/可见性，22=云链路、23/24=水仿真、25=雾密度阶段；26/27=降雨材质与水洼，由 pass A 拥有）；隔离开关 `water.scatter-source`、`volumetrics.segment-source` 等。
