...
**仍未结的一半**（远场，见 §8.9）候选方向（均未裁决，须按铁律 1 请示）：扩大网格或让格随视距缩放（代价是每帧立方数量级的射线，`gpu.visBake` 已有独立时间区）；改变出界回退值（1.0 对开阔天空是**正确**的，改它会同时影响野外）；或在网格边界渐隐天空**源**而非遮挡，使离开网格不再变亮。
...
- **会被淘汰，故推迟**：第二级联网格、扩大网格维度、提取原版天空光照作为远场来源、近远两来源混合。**在体积 ReSTIR 裁决前不得开工。**
